"""
CuteMail Django Settings
========================
Post-quantum secure email backend.
- Custom User model with public key storage
- JWT authentication
...
# SECURITY
SECRET_KEY = os.getenv('SECRET_KEY', 'django-insecure-replace-this-before-deploying')
...
WSGI_APPLICATION = 'cutemail_backend.wsgi.application'
